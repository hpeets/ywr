...
namespace play_motion_msgs
{
  ...
  class PlayMotionResult : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "play_motion_msgs/PlayMotionResult"; };
    virtual const char * getMD5() override { return "5560cb9a7211cb4b5a730f6f07ec124b"; };
