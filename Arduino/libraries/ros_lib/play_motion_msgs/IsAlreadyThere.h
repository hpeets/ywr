...
static const char ISALREADYTHERE[] = "play_motion_msgs/IsAlreadyThere";
  ...
  class IsAlreadyThereRequest : public ros::Msg
  {
    ...
    virtual const char * getType() override { return ISALREADYTHERE; };
    virtual const char * getMD5() override { return "99caf0c415b632c6336d7371da3ff931"; };
  ...
  class IsAlreadyThereResponse : public ros::Msg
  {
    ...
    virtual const char * getType() override { return ISALREADYTHERE; };
    virtual const char * getMD5() override { return "ab529bf62f4cfd6bb0a78ed51c04fcba"; };
