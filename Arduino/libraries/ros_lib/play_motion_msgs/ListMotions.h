...
static const char LISTMOTIONS[] = "play_motion_msgs/ListMotions";
  ...
  class ListMotionsRequest : public ros::Msg
  {
    ...
    virtual const char * getType() override { return LISTMOTIONS; };
  ...
  class ListMotionsResponse : public ros::Msg
  {
    ...
    ListMotionsResponse():
      motions_length(0), st_motions(), motions(nullptr)
    {
    }
    ...
    virtual const char * getType() override { return LISTMOTIONS; };
    virtual const char * getMD5() override { return "151d88e888f918ab21ebda2cef4dd23c"; };
