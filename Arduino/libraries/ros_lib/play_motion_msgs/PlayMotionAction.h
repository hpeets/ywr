...
namespace play_motion_msgs
{
  ...
  class PlayMotionAction : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "play_motion_msgs/PlayMotionAction"; };
    virtual const char * getMD5() override { return "b18530db1ae596c4c0ca2ede0819fc9e"; };
