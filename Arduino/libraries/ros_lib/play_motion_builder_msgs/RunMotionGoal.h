...
namespace play_motion_builder_msgs
{
  ...
  class RunMotionGoal : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "play_motion_builder_msgs/RunMotionGoal"; };
    virtual const char * getMD5() override { return "93fd2cd7e64669cfb4a792f5ad9e13ef"; };
