...
static const char EDITMOTION[] = "play_motion_builder_msgs/EditMotion";
  ...
  class EditMotionRequest : public ros::Msg
  {
    ...
    virtual const char * getType() override { return EDITMOTION; };
    virtual const char * getMD5() override { return "994d269af2f608a6b9a823b10da14d7d"; };
  ...
  class EditMotionResponse : public ros::Msg
  {
    ...
    virtual const char * getType() override { return EDITMOTION; };
    virtual const char * getMD5() override { return "b8977f11190208bf644de5781a8adaa9"; };
