...
static const char CHANGEJOINTS[] = "play_motion_builder_msgs/ChangeJoints";
  ...
  class ChangeJointsRequest : public ros::Msg
  {
    ...
    ChangeJointsRequest():
      group(""),
      joints_to_remove_length(0), st_joints_to_remove(), joints_to_remove(nullptr),
      joints_to_add_length(0), st_joints_to_add(), joints_to_add(nullptr)
    {
    }
    ...
    virtual const char * getType() override { return CHANGEJOINTS; };
    virtual const char * getMD5() override { return "973a28a7a5f5fe66851191cc72cc5580"; };
  ...
  class ChangeJointsResponse : public ros::Msg
  {
    ...
    ChangeJointsResponse():
      ...
      message(""),
      current_group(""),
      used_joints_length(0), st_used_joints(), used_joints(nullptr)
    {
    }
    ...
    virtual const char * getType() override { return CHANGEJOINTS; };
    virtual const char * getMD5() override { return "84aa9b65e836172877daea91a88d9de9"; };
