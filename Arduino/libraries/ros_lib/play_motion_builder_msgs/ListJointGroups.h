...
static const char LISTJOINTGROUPS[] = "play_motion_builder_msgs/ListJointGroups";
  ...
  class ListJointGroupsRequest : public ros::Msg
  {
    ...
    virtual const char * getType() override { return LISTJOINTGROUPS; };
  ...
  class ListJointGroupsResponse : public ros::Msg
  {
    ...
    ListJointGroupsResponse():
      ...
      additional_joints_length(0), st_additional_joints(), additional_joints(nullptr),
      available_joints_length(0), st_available_joints(), available_joints(nullptr)
    {
    }
    ...
    virtual const char * getType() override { return LISTJOINTGROUPS; };
    virtual const char * getMD5() override { return "9fdaed4e1eb95768801699335d06285a"; };
