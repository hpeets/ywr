...
namespace play_motion_builder_msgs
{
  ...
  class BuildMotionGoal : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "play_motion_builder_msgs/BuildMotionGoal"; };
    virtual const char * getMD5() override { return "56c5b2babfc4b27e5a596091bb964bc2"; };
