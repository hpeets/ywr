...
namespace play_motion_builder_msgs
{
  ...
  class BuildMotionActionGoal : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "play_motion_builder_msgs/BuildMotionActionGoal"; };
    virtual const char * getMD5() override { return "157ed3a8787d99d1a11d0ce8a596f3b7"; };
