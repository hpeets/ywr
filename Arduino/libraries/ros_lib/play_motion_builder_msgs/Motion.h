...
namespace play_motion_builder_msgs
{
  ...
  class Motion : public ros::Msg
  {
    ...
    Motion():
      ...
      keyframes_length(0), st_keyframes(), keyframes(nullptr),
      used_group("")
    {
    }
    ...
    virtual const char * getType() override { return "play_motion_builder_msgs/Motion"; };
    virtual const char * getMD5() override { return "0cd6cb21dc200c52ee3c8d281eccf636"; };
