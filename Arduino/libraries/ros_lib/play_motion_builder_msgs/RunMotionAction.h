...
namespace play_motion_builder_msgs
{
  ...
  class RunMotionAction : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "play_motion_builder_msgs/RunMotionAction"; };
    virtual const char * getMD5() override { return "57a10b77720536607404de3a23075f21"; };
